...
Toda a configuracao fica em `../config/configuracao.env`.

1. Preencha o IP deste computador e os dados do MySQL em `suporte/config/configuracao.env`.
2. Execute `npm install` nesta pasta na primeira instalação.
3. Abra `suporte/scripts/iniciar_api.cmd` e mantenha a janela aberta.
4. Para gerar o aplicativo, abra `suporte/scripts/gerar_apk.cmd`.
